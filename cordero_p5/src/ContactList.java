...
public class ContactList {
    ...
    public void add(ContactItem contactItem) {
        if (contactItem.getFirstName().isBlank() && contactItem.getLastName().isBlank() && contactItem.getPhoneNumber().isBlank() && contactItem.getEmail().isBlank()) {
        ...
        try (Scanner FILE = new Scanner(Paths.get(savename))) {
            ...
            if (titleOfFile.equalsIgnoreCase("Saved Contacts")) {
                while (FILE.hasNext()) {
                    ...
                    ContactItem newItem = new ContactItem(first, last, phone, email);
